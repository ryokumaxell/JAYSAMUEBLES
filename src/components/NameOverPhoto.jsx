...
export default function NamOverPhot(props) {
  ...
  return (
    <figure className="w-1/2 relative my-auto p-2">
      <img src={src} alt={alt} title={title} />
      <figcaption className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-lg font-bold text-center">
        {text}
      </figcaption>
    </figure>
  );
